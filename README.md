...
- 2 行: 残る失敗は ψ_0(Ω_3 + ψ_2(Ω_3 + β)) 型（例 (0,0)(1,1)(2,2)(3,3)(3,2)）。この型で規則 R2 の潰し方が合っていない。
- 3 行: 原表の表記経由で 4483 行。約 2000 行は検査で指摘なし、残りは主に上と同じ型（最後の項が段 2 以上のとき）で指摘あり。
